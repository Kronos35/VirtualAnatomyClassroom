          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="https://adminlte.io/themes/AdminLTE/dist/img/user6-128x128.jpg" alt="User Image">
                        <span class="username">
                          <a href="#">Adam Jones</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                  ...
                  <div class="row margin-bottom">
                    ...
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          <img class="img-responsive" src="https://adminlte.io/themes/AdminLTE/dist/img/photo2.png" alt="Photo">
                          <br>
                          <img class="img-responsive" src="https://adminlte.io/themes/AdminLTE/dist/img/photo3.jpg" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <img class="img-responsive" src="https://adminlte.io/themes/AdminLTE/dist/img/photo4.jpg" alt="Photo">
                          <br>
                          <img class="img-responsive" src="https://adminlte.io/themes/AdminLTE/dist/img/photo1.png" alt="Photo">
                        </div>
                        <!-- /.col -->
